...
class Chat:
    ...
    def upload_video(self, image, conv, img_list, num_segments):
        ...
        new_pos_emb = self.get_sinusoid_encoding_table(
            n_position=(224 // 16) ** 2 * num_segments, cur_frame=num_segments
        )
    ...
    def get_context_emb(self, conv, img_list):
        ...
        ), "Unmatched numbers of visual placeholders and videos."
        with torch.no_grad():
            seg_tokens = [
            ...
            seg_embs = [
                self.model.llama_model.base_model.model.model.embed_tokens(seg_t)
